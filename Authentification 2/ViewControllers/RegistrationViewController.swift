   ...
   let segmentedControl: UISegmentedControl = {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            cell.loginField.placeholder = "Введите e-mail"
            return cell
        case 1:
            let cell: TableViewCell = myTableView.dequeueReusableCell(withIdentifier: "TableViewCell", for: indexPath) as! TableViewCell
            cell.loginField.placeholder = "Придумайте имя"
            return cell
        case 2:
            let cell: TableViewCell = myTableView.dequeueReusableCell(withIdentifier: "TableViewCell", for: indexPath) as! TableViewCell
            cell.loginField.placeholder = "Придумайте пароль"
            cell.loginField.isSecureTextEntry = true
            return cell
        default:
            let cell: TableViewCell = myTableView.dequeueReusableCell(withIdentifier: "TableViewCell", for: indexPath) as! TableViewCell
            cell.loginField.placeholder = "Повторите пароль"
            cell.loginField.isSecureTextEntry = true
            return cell
        }
    }
